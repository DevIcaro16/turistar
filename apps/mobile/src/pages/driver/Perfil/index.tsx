                ...
                >
                    {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldValue }) => (
                        <View style={styles.infoContainer}>
                            ...
                            <View style={styles.infoRow}>
                                <MaterialIcons name={getTransportIcon(values.transport_type)} size={22} color="#007AFF" />
                                {editFields ? (
                            ...
                            {touched.transport_type && errors.transport_type && (
                                <Text style={{ color: 'red', marginLeft: 34, marginTop: -12, marginBottom: 12 }}>{errors.transport_type}</Text>
                            )}
